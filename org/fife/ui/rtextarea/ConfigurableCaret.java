...
public class ConfigurableCaret extends DefaultCaret
{
    ...
    protected Highlighter.HighlightPainter getSelectionPainter() {
        return (Highlighter.HighlightPainter)this.selectionPainter;
    }
    ...
    public void mouseClicked(final MouseEvent e) {
        if (!e.isConsumed()) {
            ...
            else if (SwingUtilities.isMiddleMouseButton(e) && this.getPasteOnMiddleMouseClick() && nclicks == 1 && textArea.isEditable() && textArea.isEnabled()) {
