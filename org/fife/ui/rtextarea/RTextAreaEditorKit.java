...
public class RTextAreaEditorKit extends DefaultEditorKit
{
    ...
    public Action[] getActions() {
        return (Action[])RTextAreaEditorKit.defaultActions;
    }
        ...
        public void actionPerformedImpl(final ActionEvent e, final RTextArea textArea) {
            ...
            try {
                if (textArea.getLineWrap()) {
                    ...
                    final int begOffs = newPos = Utilities.getRowStart((JTextComponent)textArea, offs);
                }
                else {
    ...
    protected static class BeginWordAction extends RecordableTextAction
    {
        ...
        protected int getWordStart(final RTextArea textArea, final int offs) throws BadLocationException {
            return Utilities.getWordStart((JTextComponent)textArea, offs);
        }
    }
    ...
    public static class ClipboardHistoryAction extends RecordableTextAction
    {
        ...
        public ClipboardHistoryAction(final String name, final Icon icon, final String desc, final Integer mnemonic, final KeyStroke accelerator) {
            super(name, icon, desc, mnemonic, accelerator);
            this.clipboardHistory = ClipboardHistory.get();
        }
        
        public void actionPerformedImpl(final ActionEvent e, final RTextArea textArea) {
            final Window owner = SwingUtilities.getWindowAncestor((Component)textArea);
                ...
                try {
                    ...
                    if (dot != mark) {
                        ...
                        if (dot < doc.getLength() - 1) {
                            ...
                            final char c2 = dotChars.charAt(1);
                            if (c0 >= '\ud800' && c0 <= '\udbff' && c2 >= '\udc00' && c2 <= '\udfff') {
                                delChars = 2;
                            }
                        }
    ...
    public static class DeletePrevWordAction extends RecordableTextAction
    {
        ...
        protected int getPreviousWordStart(final RTextArea textArea, final int end) throws BadLocationException {
            return Utilities.getPreviousWord((JTextComponent)textArea, end);
        }
    }
    ...
    public static class DumbCompleteWordAction extends RecordableTextAction
    {
        ...
        public DumbCompleteWordAction() {
            ...
            final int lastWordStart = -1;
            this.lastDot = lastWordStart;
            this.searchOffs = lastWordStart;
        ...
        protected int getPreviousWord(final RTextArea textArea, final int offs) throws BadLocationException {
            return Utilities.getPreviousWord((JTextComponent)textArea, offs);
        }
        
        protected int getWordEnd(final RTextArea textArea, final int offs) throws BadLocationException {
            return Utilities.getWordEnd((JTextComponent)textArea, offs);
        }
    ...
    public static class InsertBreakAction extends RecordableTextAction
    {
        ...
        public boolean isEnabled() {
            final JTextComponent tc = this.getTextComponent((ActionEvent)null);
    ...
    public static class LineMoveAction extends RecordableTextAction
    {
        ...
        private void moveLineDown(final RTextArea textArea, final int line, final int lineCount) throws BadLocationException {
            final Document doc = textArea.getDocument();
            final Element root = doc.getDefaultRootElement();
        ...
        private void moveLineUp(final RTextArea textArea, final int line, final int moveCount) throws BadLocationException {
            final Document doc = textArea.getDocument();
            final Element root = doc.getDefaultRootElement();
            Element elem = root.getElement(line);
            final int start = elem.getStartOffset();
                ...
                try {
                    ...
                    if (this.forward) {
                        ...
                        for (int i = bookmarks.length - 1; i >= 0; --i) {
                            final GutterIconInfo bookmark2 = bookmarks[i];
                            final int offs2 = bookmark2.getMarkedOffset();
                    ...
                    int offs3 = moveTo.getMarkedOffset();
                    if (textArea instanceof RSyntaxTextArea) {
                        final RSyntaxTextArea rsta = (RSyntaxTextArea)textArea;
                        if (rsta.isCodeFoldingEnabled()) {
                            rsta.getFoldManager().ensureOffsetNotInClosedFold(offs3);
                        }
                    }
                    final int line3 = textArea.getLineOfOffset(offs3);
                    offs3 = textArea.getLineStartOffset(line3);
                    textArea.setCaretPosition(offs3);
                }
                catch (BadLocationException ble) {
                    UIManager.getLookAndFeel().provideErrorFeedback((Component)textArea);
                    ble.printStackTrace();
    ...
    public static class NextOccurrenceAction extends RecordableTextAction
    {
        ...
        public void actionPerformedImpl(final ActionEvent e, final RTextArea textArea) {
            ...
            if (!SearchEngine.find((JTextArea)textArea, context).wasFound()) {
                UIManager.getLookAndFeel().provideErrorFeedback((Component)textArea);
            }
    ...
    public static class NextVisualPositionAction extends RecordableTextAction
    {
        ...
        public void actionPerformedImpl(final ActionEvent e, final RTextArea textArea) {
            ...
            try {
                ...
                if (filter != null) {
                    dot = filter.getNextVisualPositionFrom((JTextComponent)textArea, dot, Position.Bias.Forward, this.direction, bias);
                }
                else {
                    dot = textArea.getUI().getNextVisualPositionFrom((JTextComponent)textArea, dot, Position.Bias.Forward, this.direction, bias);
                }
                if (this.select) {
                    caret.moveDot(dot);
                }
    ...
    public static class NextWordAction extends RecordableTextAction
    {
        ...
        public void actionPerformedImpl(final ActionEvent e, final RTextArea textArea) {
            ...
            final Element curPara = Utilities.getParagraphElement((JTextComponent)textArea, offs);
            try {
        ...
        protected int getNextWord(final RTextArea textArea, final int offs) throws BadLocationException {
            return Utilities.getNextWord((JTextComponent)textArea, offs);
        }
    }
    ...
    static class PageAction extends RecordableTextAction
    {
        ...
        public void actionPerformedImpl(final ActionEvent e, final RTextArea textArea) {
            ...
            if (this.left) {
                ...
                final Rectangle rectangle = visible;
                rectangle.x += visible.width;
            }
        ...
        public void actionPerformedImpl(final ActionEvent e, final RTextArea textArea) {
            ...
            try {
                ...
                if (offs < curPara.getStartOffset()) {
                    offs = Utilities.getParagraphElement((JTextComponent)textArea, offs).getEndOffset() - 1;
                }
            }
    ...
    public static class ScrollAction extends RecordableTextAction
    {
        ...
        public void actionPerformedImpl(final ActionEvent e, final RTextArea textArea) {
            ...
            if (parent instanceof JViewport) {
                ...
                final Point p = viewPosition = viewport.getViewPosition();
                viewPosition.y += this.delta * textArea.getLineHeight();
                if (p.y < 0) {
                    p.y = 0;
                }
                else {
    ...
    public static class SelectLineAction extends RecordableTextAction
    {
        ...
        public SelectLineAction() {
            super("select-line");
            this.start = (Action)new BeginLineAction("pigdog", false);
            this.end = (Action)new EndLineAction("pigdog", true);
        }
    ...
    public static class SelectWordAction extends RecordableTextAction
    {
        ...
        protected void createActions() {
            this.start = (Action)new BeginWordAction("pigdog", false);
            this.end = (Action)new EndWordAction("pigdog", true);
        }
        ...
        public void actionPerformedImpl(final ActionEvent e, final RTextArea textArea) {
            ...
            if (selectedIndex != -1) {
                try {
                    ...
                    final int yOffset = this.direction * ((int)Math.ceil(scrollAmount / (double)h) - 1) * h;
                    newVis.y = this.constrainY((JTextComponent)textArea, initialY + yOffset, yOffset, visible.height);
                    int newIndex;
                    if (visible.contains(dotBounds.x, dotBounds.y)) {
                        newIndex = textArea.viewToModel(new Point(x, this.constrainY((JTextComponent)textArea, dotBounds.y + yOffset, 0, 0)));
                    }
                    ...
                    newIndex = this.constrainOffset((JTextComponent)textArea, newIndex);
                    if (newIndex != selectedIndex) {
                        this.adjustScrollIfNecessary((JTextComponent)textArea, newVis, initialY, newIndex);
                        if (this.select) {
