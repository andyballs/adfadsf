...
public class TokenImpl implements Token
{
    ...
    public TokenImpl(final Segment line, final int beg, final int end, final int startOffset, final int type, final int languageIndex) {
        this(line.array, beg, end, startOffset, type, languageIndex);
    }
    
    public TokenImpl(final char[] line, final int beg, final int end, final int startOffset, final int type, final int languageIndex) {
        this();
    ...
    private StringBuilder appendHtmlLexeme(final RSyntaxTextArea textArea, final StringBuilder sb, final boolean tabsToSpaces) {
    ...
    public Token getLastNonCommentNonWhitespaceToken() {
        Token last = null;
        for (Token t = (Token)this; t != null && t.isPaintable(); t = t.getNextToken()) {
            switch (t.getType()) {
                case 1:
                case 2:
                case 3:
    ...
    public Token getLastPaintableToken() {
        Token next;
        for (Token t = (Token)this; t.isPaintable(); t = next) {
            next = t.getNextToken();
