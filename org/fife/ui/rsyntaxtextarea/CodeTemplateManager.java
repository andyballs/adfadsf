...
public class CodeTemplateManager
{
    ...
    public synchronized CodeTemplate getTemplate(final RSyntaxTextArea textArea) {
        ...
        try {
            ...
            final int index = Collections.binarySearch((List<? extends Segment>)this.templates, this.s, this.comparator);
    ...
    public synchronized boolean saveTemplates() {
        ...
        for (final File oldXMLFile : oldXMLFiles) {
            oldXMLFile.delete();
        }
    ...
    private static class TemplateComparator implements Comparator<Object>, Serializable
    {
        ...
        public int compare(final Object template, final Object segment) {
            ...
            int len2 = s.count;
            int j;
            for (j = s.offset + len2 - 1; j >= s.offset && isValidChar(segArray[j]); --j) {}
