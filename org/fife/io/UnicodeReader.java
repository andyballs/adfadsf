...
public class UnicodeReader extends Reader
{
    ...
    public UnicodeReader(final File file, final Charset defaultCharset) throws IOException {
    ...
    public UnicodeReader(final InputStream in, final Charset defaultCharset) throws IOException {
        this.internalIn = null;
        this.init(in, defaultCharset.name());
    }
