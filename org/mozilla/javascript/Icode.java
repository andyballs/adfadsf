...
abstract class Icode
{
    ...
    static String bytecodeName(final int bytecode) {
    ...
    static boolean validIcode(final int icode) {
        return -64 <= icode && icode <= 0;
    }
    
    static boolean validTokenCode(final int token) {
        return 2 <= token && token <= 77;
    }
    
    static boolean validBytecode(final int bytecode) {
