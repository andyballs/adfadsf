...
public final class ByteQuadsCanonicalizer
{
    ...
    private ByteQuadsCanonicalizer(int sz, final int seed) {
        this._parent = null;
        this._count = 0;
    ...
    private ByteQuadsCanonicalizer(final ByteQuadsCanonicalizer parent, final int seed, final TableInfo state, final boolean intern, final boolean failOnDoS) {
        this._parent = parent;
        this._seed = seed;
        this._intern = intern;
    ...
    private ByteQuadsCanonicalizer(final TableInfo state) {
        this._parent = null;
        this._seed = 0;
        this._intern = false;
        this._failOnDoS = true;
    ...
    public ByteQuadsCanonicalizer makeChildOrPlaceholder(final int flags) {
    ...
    public String addName(String name, final int q1, final int q2) {
        ...
        final int hash = this.calcHash(q1, q2);
