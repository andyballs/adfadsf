...
public abstract class NonBlockingJsonParserBase extends ParserBase
{
    ...
    public JacksonFeatureSet<StreamReadCapability> getReadCapabilities() {
        return (JacksonFeatureSet<StreamReadCapability>)NonBlockingJsonParserBase.JSON_READ_CAPABILITIES;
    }
    ...
    public JsonLocation getCurrentLocation() {
        ...
        return new JsonLocation(this._contentReference(), this._currInputProcessed + (this._inputPtr - this._currBufferStart), -1L, row, col);
    }
    ...
    protected final JsonToken _valueNonStdNumberComplete(final int type) throws IOException {
        ...
        if (!this.isEnabled(JsonParser.Feature.ALLOW_NON_NUMERIC_NUMBERS)) {
            this._reportError("Non-standard token '%s': enable JsonParser.Feature.ALLOW_NON_NUMERIC_NUMBERS to allow", (Object)tokenStr);
        }
        this._intLength = 0;
