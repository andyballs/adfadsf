...
public final class ByteSourceJsonBootstrapper
{
        ...
        switch (enc.bits()) {
            ...
            case 16: {
                ...
                if (in == null) {
                    ...
                    in = (InputStream)new MergedStream(this._context, in, this._inputBuffer, this._inputPtr, this._inputEnd);
                }
    ...
    public JsonParser constructParser(final int parserFeatures, final ObjectCodec codec, final ByteQuadsCanonicalizer rootByteSymbols, final CharsToNameCanonicalizer rootCharSymbols, final int factoryFeatures) throws IOException {
        ...
        return (JsonParser)new ReaderBasedJsonParser(this._context, parserFeatures, this.constructReader(), codec, rootCharSymbols.makeChild(factoryFeatures));
    }
