...
public class ReaderBasedJsonParser extends ParserBase
{
    ...
    public JacksonFeatureSet<StreamReadCapability> getReadCapabilities() {
        return (JacksonFeatureSet<StreamReadCapability>)ReaderBasedJsonParser.JSON_READ_CAPABILITIES;
    }
                ...
                if (bits < 0) {
                    ...
                    if (bits == -2) {
                        ...
                        if (!b64variant.usesPaddingChar(ch) && this._decodeBase64Escape(b64variant, ch, 3) != -2) {
                            throw this.reportInvalidBase64Char(b64variant, (int)ch, 3, "expected padding character '" + b64variant.getPaddingChar() + "'");
                        }
                        decodedData >>= 4;
                        buffer[outputPtr++] = (byte)decodedData;
                        continue;
    ...
    private final JsonToken _parseNumber2(final boolean neg, final int startPtr) throws IOException {
            ...
            if (c == '.') {
                ...
                while (true) {
                    while (this._inputPtr < this._inputEnd || this._loadMore()) {
                        ...
                        if (fractLen == 0) {
                            this.reportUnexpectedNumberChar((int)c, "Decimal point not followed by a digit");
                        }
                        break Label_0348;
                    }
                    eof = true;
        ...
        if (c == 'e' || c == 'E') {
            ...
            if (expLen == 0) {
                this.reportUnexpectedNumberChar((int)c, "Exponent indicator not followed by a digit");
            }
        }
        if (!eof) {
            --this._inputPtr;
    ...
    private void _skipComment() throws IOException {
        ...
        if (c == '/') {
            ...
            this._reportUnexpectedChar((int)c, "was expecting either '*' or '/' for a comment");
        }
    }
    ...
    public JsonLocation getCurrentLocation() {
        ...
        return new JsonLocation(this._contentReference(), -1L, this._currInputProcessed + this._inputPtr, this._currInputRow, col);
    }
    ...
    protected void _reportInvalidToken(final String matchedPart, final String msg) throws IOException {
        ...
        this._reportError("Unrecognized token '%s': was expecting %s", (Object)sb, (Object)msg);
    }
