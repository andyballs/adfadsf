...
public class UTF8StreamJsonParser extends ParserBase
{
    ...
    public JacksonFeatureSet<StreamReadCapability> getReadCapabilities() {
        return (JacksonFeatureSet<StreamReadCapability>)UTF8StreamJsonParser.JSON_READ_CAPABILITIES;
    }
    ...
    protected JsonToken _handleInvalidNumberStart(int ch, final boolean neg) throws IOException {
        while (ch == 73) {
            ...
            this._reportError("Non-standard token '%s': enable JsonParser.Feature.ALLOW_NON_NUMERIC_NUMBERS to allow", (Object)match);
        }
    ...
    public JsonLocation getCurrentLocation() {
        ...
        return new JsonLocation(this._contentReference(), this._currInputProcessed + this._inputPtr, -1L, this._currInputRow, col);
    }
