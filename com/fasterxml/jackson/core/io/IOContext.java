...
public class IOContext
{
    ...
    public IOContext(final BufferRecycler br, final ContentReference contentRef, final boolean managedResource) {
    ...
    @Deprecated
    public IOContext(final BufferRecycler br, final Object rawContent, final boolean managedResource) {
