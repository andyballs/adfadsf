...
public abstract class ParserBase extends ParserMinimalBase
{
    ...
    protected void _reportMismatchedEndMarker(final int actCh, final char expCh) throws JsonParseException {
        ...
        this._reportError(String.format("Unexpected close marker '%s': expected '%c' (for %s starting at %s)", (char)actCh, expCh, ctxt.typeDesc(), ctxt.startLocation(this._contentReference())));
    }
