...
public class JsonFactory extends TokenStreamFactory implements Versioned, Serializable
{
    ...
    public JsonFactory setRootValueSeparator(final String sep) {
        this._rootValueSeparator = (SerializableString)((sep == null) ? null : new SerializedString(sep));
        return this;
    }
    ...
    public JsonParser createParser(final File f) throws IOException, JsonParseException {
        final IOContext ctxt = this._createContext(this._createContentReference(f), true);
    ...
    public JsonParser createParser(final URL url) throws IOException, JsonParseException {
        final IOContext ctxt = this._createContext(this._createContentReference(url), true);
    ...
    public JsonParser createParser(final InputStream in) throws IOException, JsonParseException {
        final IOContext ctxt = this._createContext(this._createContentReference(in), false);
        return this._createParser(this._decorate(in, ctxt), ctxt);
    }
    
    @Override
    public JsonParser createParser(final Reader r) throws IOException, JsonParseException {
        final IOContext ctxt = this._createContext(this._createContentReference(r), false);
    ...
    public JsonParser createParser(final byte[] data) throws IOException, JsonParseException {
        final IOContext ctxt = this._createContext(this._createContentReference(data), true);
    ...
    public JsonParser createParser(final byte[] data, final int offset, final int len) throws IOException, JsonParseException {
        final IOContext ctxt = this._createContext(this._createContentReference(data, offset, len), true);
        if (this._inputDecorator != null) {
    ...
    public JsonParser createParser(final String content) throws IOException, JsonParseException {
        ...
        final IOContext ctxt = this._createContext(this._createContentReference(content), true);
    ...
    public JsonGenerator createGenerator(final OutputStream out, final JsonEncoding enc) throws IOException {
        final IOContext ctxt = this._createContext(this._createContentReference(out), false);
    ...
    public JsonGenerator createGenerator(final Writer w) throws IOException {
        final IOContext ctxt = this._createContext(this._createContentReference(w), false);
        return this._createGenerator(this._decorate(w, ctxt), ctxt);
    }
    ...
    public JsonGenerator createGenerator(final File f, final JsonEncoding enc) throws IOException {
        ...
        final IOContext ctxt = this._createContext(this._createContentReference(out), true);
        ctxt.setEncoding(enc);
        if (enc == JsonEncoding.UTF8) {
            return this._createUTF8Generator(this._decorate(out, ctxt), ctxt);
        }
    ...
    protected JsonParser _createParser(final Reader r, final IOContext ctxt) throws IOException {
        return (JsonParser)new ReaderBasedJsonParser(ctxt, this._parserFeatures, r, this._objectCodec, this._rootCharSymbols.makeChild(this._factoryFeatures));
    }
    ...
    protected JsonParser _createParser(final char[] data, final int offset, final int len, final IOContext ctxt, final boolean recyclable) throws IOException {
        return (JsonParser)new ReaderBasedJsonParser(ctxt, this._parserFeatures, (Reader)null, this._objectCodec, this._rootCharSymbols.makeChild(this._factoryFeatures), data, offset, offset + len, recyclable);
    }
    ...
    protected IOContext _createContext(ContentReference contentRef, final boolean resourceManaged) {
        if (contentRef == null) {
    ...
    @Deprecated
    protected IOContext _createContext(final Object rawContentRef, final boolean resourceManaged) {
    ...
    protected ContentReference _createContentReference(final Object contentAccessor) {
        return ContentReference.construct(!this.canHandleBinaryNatively(), contentAccessor);
    }
    
    protected ContentReference _createContentReference(final Object contentAccessor, final int offset, final int length) {
